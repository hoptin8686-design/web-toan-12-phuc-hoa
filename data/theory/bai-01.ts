...
const bai01: LessonTheory = {
  "intro": "Khảo sát tính đơn điệu và cực trị thông qua đạo hàm cấp 1 f'(x).",
  "minutes": 15,
  "sections": [
    {
      "id": "trong-tam",
      ...
      "blocks": [
          ...
          "items": [
            {
              ...
              "text": "Nắm vững định nghĩa, ý nghĩa hình học và giải tích của Bài 1. Tính đơn điệu và cực trị của hàm số."
            },
            {
              "emoji": "⚡",
        ...
        },
        {
          ...
          "formula": "f'(x) > 0 \\implies \\text{đồng biến}; \\quad f'(x) < 0 \\implies \\text{nghịch biến}",
  ...
  "summary": [
    "Nắm vững các khái niệm và công thức cốt lõi của Bài 1. Tính đơn điệu và cực trị của hàm số.",
