...
const bai02: LessonTheory = {
  "intro": "Phương pháp tìm giá trị lớn nhất và giá trị nhỏ nhất của hàm số trên đoạn và khoảng.",
  "minutes": 15,
  "sections": [
    {
      "id": "trong-tam",
          ...
          "items": [
            {
              ...
              "text": "Nắm vững định nghĩa, ý nghĩa hình học và giải tích của Bài 2. Giá trị lớn nhất và giá trị nhỏ nhất của hàm số."
            },
            {
              "emoji": "⚡",
  ...
  "summary": [
    "Nắm vững các khái niệm và công thức cốt lõi của Bài 2. Giá trị lớn nhất và giá trị nhỏ nhất của hàm số.",
