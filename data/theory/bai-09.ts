...
const bai09: LessonTheory = {
  "intro": "Các số đặc trưng đo mức độ phân tán: Khoảng biến thiên R và khoảng tứ phân vị Delta Q của mẫu ghép nhóm.",
  "minutes": 15,
  "sections": [
    {
      "id": "trong-tam",
      ...
      "blocks": [
          ...
          "items": [
            {
              ...
              "text": "Nắm vững định nghĩa, ý nghĩa hình học và giải tích của Bài 9. Khoảng biến thiên và khoảng tứ phân vị."
            },
            {
              "emoji": "⚡",
        ...
        },
        {
          ...
          "formula": "R = a_{k+1} - a_1, \\quad \\Delta Q = Q_3 - Q_1",
  ...
  "summary": [
    "Nắm vững các khái niệm và công thức cốt lõi của Bài 9. Khoảng biến thiên và khoảng tứ phân vị.",
