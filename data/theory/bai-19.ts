...
const bai19: LessonTheory = {
  "intro": "Công thức xác suất toàn phần và công thức Bayes - ứng dụng quan trọng trong chẩn đoán y khoa và trí tuệ nhân tạo.",
  "minutes": 15,
  "sections": [
    {
      "id": "trong-tam",
          ...
          "items": [
            {
              ...
              "text": "Nắm vững định nghĩa, ý nghĩa hình học và giải tích của Bài 19. Công thức xác suất toàn phần và công thức Bayes."
            },
            {
              "emoji": "⚡",
  ...
  "summary": [
    "Nắm vững các khái niệm và công thức cốt lõi của Bài 19. Công thức xác suất toàn phần và công thức Bayes.",
